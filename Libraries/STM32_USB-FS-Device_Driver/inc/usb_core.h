...
{
	u8 cUSBbmRequestType;     /*USB Setup bmRequest Type*/
	u8 cUSBbRequest;			/*USB Setup bRequest */
	u16 wUSBwVulue;				/* USB Setup wValue */
	u16 wUSBwIndex;			/* USB Setup wIndex */
	u16 wUSBwLength;			/* USB Setup wLength */
