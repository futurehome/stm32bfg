	...
	if(USB_Tx_State != 1)
  	{
    		...
    		if (USART_Rx_length > MAX_USB_DATA_PACKET_SIZE)
    		{
      			USB_Tx_ptr = USART_Rx_ptr_out;
      			USB_Tx_length = MAX_USB_DATA_PACKET_SIZE;
      
      			USART_Rx_ptr_out += MAX_USB_DATA_PACKET_SIZE;	
      			USART_Rx_length -= MAX_USB_DATA_PACKET_SIZE;	
    		}
    		else
    		{
      			USB_Tx_ptr = USART_Rx_ptr_out;
