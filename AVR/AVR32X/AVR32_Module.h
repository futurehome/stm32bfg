...
#define AVR32_POSCSR								(*((  unsigned int*)0xFFFF0C54))
#define AVR32_PLL0									(*((  unsigned int*)0xFFFF0C20))
#define AVR32_PLL1									(*((  unsigned int*)0xFFFF0C24))
#define AVR32_OSCCTRL0								(*((  unsigned int*)0xFFFF0C28))
#define AVR32_MCCTRL								(*((  unsigned int*)0xFFFF0C00))
#define AVR32_CKSEL									(*((  unsigned int*)0xFFFF0C04))
#define AVR32_GCCTRL								(*((  unsigned int*)0xFFFF0C60))
#define AVR32_PBAMASK								(*((  unsigned int*)0xFFFF0C10))

#define AVR32_SPI0_CR								(*((  unsigned int*)0xFFFF2400))
#define AVR32_SPI0_MR								(*((  unsigned int*)0xFFFF2404))
#define AVR32_SPI0_CSR0								(*((  unsigned int*)0xFFFF2430))
#define AVR32_SPI0_TDR								(*((  unsigned int*)0xFFFF240C))
#define AVR32_SPI0_RDR								(*((  unsigned int*)0xFFFF2408))
#define AVR32_SPI0_SR								(*((  unsigned int*)0xFFFF2410))

#define AVR32_SPI1_CR								(*((  unsigned int*)0xFFFF2800))
#define AVR32_SPI1_MR								(*((  unsigned int*)0xFFFF2804))
#define AVR32_SPI1_CSR0								(*((  unsigned int*)0xFFFF2830))
#define AVR32_SPI1_TDR								(*((  unsigned int*)0xFFFF280C))
#define AVR32_SPI1_RDR								(*((  unsigned int*)0xFFFF2808))
#define AVR32_SPI1_SR								(*((  unsigned int*)0xFFFF2810))

#define AVR32_FLASHC_MAIN							(*((  unsigned int*)0xFFFE1400))
#define AVR32_FLASHC_CONTROL						(*((  unsigned int*)0xFFFE1400))
#define AVR32_FLASHC_COMMAND						(*((  unsigned int*)0xFFFE1404))
#define AVR32_FLASHC_STATUS							(*((  unsigned int*)0xFFFE1408))
...
#define AVR32_A2D_CONTROL_REGISTER    				(*((  unsigned int*)AVR32_A2D_CONTROL_REGISTER_ADRS))
#define AVR32_A2D_MODE_REGISTER      				(*((  unsigned int*)AVR32_A2D_MODE_REGISTER_ADRS))
#define AVR32_A2D_CHANNEL_ENABLE_REGISTER			(*((  unsigned int*)AVR32_A2D_CHANNEL_ENABLE_REGISTER_ADRS))
#define AVR32_A2D_CHANNEL_STATUS_REGISTER			(*((  unsigned int*)AVR32_A2D_CHANNEL_STATUS_REGISTER_ADRS))
#define AVR32_A2D_STATUS_REGISTER					(*((  unsigned int*)AVR32_A2D_STATUS_REGISTER_ADRS))

#define AVR32_A2D_CDR0								(*((  unsigned int*)AVR32_A2D_CDR0_ADRS))
#define AVR32_A2D_CDR1								(*((  unsigned int*)AVR32_A2D_CDR1_ADRS))
#define AVR32_A2D_CDR2								(*((  unsigned int*)AVR32_A2D_CDR2_ADRS))
#define AVR32_A2D_CDR3								(*((  unsigned int*)AVR32_A2D_CDR3_ADRS))
#define AVR32_A2D_CDR4								(*((  unsigned int*)AVR32_A2D_CDR4_ADRS))
#define AVR32_A2D_CDR5								(*((  unsigned int*)AVR32_A2D_CDR5_ADRS))
#define AVR32_A2D_CDR6								(*((  unsigned int*)AVR32_A2D_CDR6_ADRS))
#define AVR32_A2D_CDR7								(*((  unsigned int*)AVR32_A2D_CDR7_ADRS))
...
int   __AVR32_A2D_GetTemp1(void);
int   __AVR32_A2D_GetTemp2(void);
int   __AVR32_A2D_Get3P3V(void);
int   __AVR32_A2D_Get1V(void);
int   __AVR32_A2D_GetPWR_MAIN(void);
...
//u8		__AVR32_USB_GetInformation(void);
...
int		__AVR32_Timer_GetValue(void);
