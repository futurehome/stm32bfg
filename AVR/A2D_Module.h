...
void  		 a2d_init(void);
int a2d_get_temp(unsigned int iChannel); // Can be Channel 0 or Channel 1
int a2d_get_voltage(unsigned int iVoltageChannel); // Choose between the available voltage channels
