...
int MCU_A2D_GetTemp1 ()
{
	...
	#endif
	*/
	return __ARM_A2D_GetTemp1();
}

int MCU_A2D_GetTemp2 ()
{
	/*
	#if   defined( __COMPILING_FOR_AVR32__)
	  int iRetVal = __AVR32_A2D_GetTemp2();
	return iRetVal;
	#elif defined( __COMPILING_FOR_STM32__)
...
int MCU_A2D_Get1V    ()
{
	...
	#endif
	*/
	return __ARM_A2D_Get1V_13();
}

int MCU_A2D_GetPWR_MAIN()
{
	/*
	#if   defined( __COMPILING_FOR_AVR32__)
...
void __MCU_ASIC_Activate_CS(void) // iBank can be 1 or 2
{
	/*
	#if   defined( __COMPILING_FOR_AVR32__)
	...
	#endif*/
	__ARM_ASIC_Activate_CS();
}
 
void __MCU_ASIC_Deactivate_CS(void)  // iBank can be 1 or 2
{
	/*
	#if   defined( __COMPILING_FOR_AVR32__)
